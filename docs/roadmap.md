...
### Start here → `PH.6` · Phenomena beyond opaque solids

> **The exhaust plume, on the car and the vessel.** A gas slab per pixel over the plume's cone, T and species from the exhaust node; closes the §6.6 deferral whose trigger — an MWIR Tier 3 bench — fired with `test_tier3_multiband.py`.

`PH.6` is phase P, size M, and unblocks 1 other step(s).

#### Then, in order — 78 open steps

| # | step | lane | phase | size | unblocks | waiting on |
|---|---|---|---|---|---|---|
| 1 | **`PH.6`** | PH | P | M | 1 | ready |
| 2 | **`PH.7`** | PH | P | M | 1 | ready |
| 3 | **`PH.8`** | PH | P | M | — | `PH.7` |
| 4 | **`PT.9`** | PT | A | M | 3 | ready |
| 5 | **`IG.2`** | IG | A | M | — | ready |
| 6 | **`SC.4`** | SC | A | M | — | ready |
| 7 | **`IG.16`** | IG | B | M | — | ready |
| 8 | **`PT.10`** | PT | B | M | — | `PT.9` |
| 9 | **`SE.1`** | SE | B | M | — | ready |
| 10 | **`SE.2`** | SE | B | M | — | ready |
| 11 | **`AT.7`** | AT | C | M | 1 | ready |
| 12 | **`PH.10`** | PH | C | S | — | ready |
| 13 | **`PH.11`** | PH | C | S | — | ready |
| 14 | **`PH.12`** | PH | C | S | — | ready |
| 15 | **`PH.9`** | PH | C | S | — | `PH.6` |
