...
### Start here → `PH.7` · Phenomena beyond opaque solids

> **Fire: the flame and what it heats.** A soot slab at 1150–1300 K; `RadiantRectangle` carries an authored surface emissive power (100–170 kW/m² unobscured, 30–50 smoke-obscured; Considine/Mudan) so a cell's q_int = α·F·SEP; Heskestad's plume centreline ΔT₀ replaces T_air above the fire, authored by

`PH.7` is phase P, size M, and unblocks 1 other step(s).

#### Then, in order — 77 open steps

| # | step | lane | phase | size | unblocks | waiting on |
|---|---|---|---|---|---|---|
| 1 | **`PH.7`** | PH | P | M | 1 | ready |
| 2 | **`PH.8`** | PH | P | M | — | `PH.7` |
| 3 | **`PT.9`** | PT | A | M | 3 | ready |
| 4 | **`IG.2`** | IG | A | M | — | ready |
| 5 | **`SC.4`** | SC | A | M | — | ready |
...
| 8 | **`SE.1`** | SE | B | M | — | ready |
| 9 | **`SE.2`** | SE | B | M | — | ready |
| 10 | **`AT.7`** | AT | C | M | 1 | ready |
| 11 | **`PH.10`** | PH | C | S | — | ready |
| 12 | **`PH.11`** | PH | C | S | — | ready |
| 13 | **`PH.12`** | PH | C | S | — | ready |
| 14 | **`PH.9`** | PH | C | S | — | ready |
| 15 | **`TC.8`** | TC | C | S | — | ready |
...
| PT.9 | 🟡 **half done (engine-free).** `quad_flight_pointwise.yaml` + its script regenerate the mission with the deck, belly and two arms as patched surfaces; schema v13 gives a surface a **speed schedule** so the flight drives its convection (ADR 0109). Curved binding is WM.3's, the frame IG.2's. | **Measured.** Deck − belly **29 K** on one airframe (per-prim: 0.000); 29 K across one arm from the deck's and pods' shadows; deck excess 29.3 K on the pad → 13.8 K at 13 m/s → 29.6 K landed; frozen at pad speed it never cools. | PT.1, PT.2, PT.5, WM.3 | M | A |
...
The highest ADR is 0114 (0090–0114 were written after this section was first measured; 0093–0114 by `PT.8`, `TC.1`, `PT.18`, `TC.2`, `TC.4`, `PH.13`, `TC.3`, `TC.5`, `PH.1`, `PT.11`, `PT.12`, `PT.21`, `TC.7`, `PT.15`, `PT.22`, `PH.3`, `PT.9`, `WM.5`, `PT.14`, `WM.6`, `AT.10` and `PH.6`). Four numbers below 0089 are cited and were never written: **0042** (the Level B
