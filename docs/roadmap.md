...
### Start here → `PH.8` · Phenomena beyond opaque solids

> **Fire on the camera: gain state, rail and AGC.** A `gain_state` with an intrascene ceiling (Boson: 140 °C high, 500 °C low, Rev 340) clipped in radiance before the ISP; radiometric output uncapped.

`PH.8` is phase P, size M, and unblocks 0 other step(s).
...
| 7 | **`SE.1`** | SE | B | M | — | ready |
| 8 | **`SE.2`** | SE | B | M | — | ready |
| 9 | **`AT.7`** | AT | C | M | 1 | ready |
| 10 | **`PH.10`** | PH | C | S | — | ready |
| 11 | **`PH.11`** | PH | C | S | — | ready |
| 12 | **`PH.12`** | PH | C | S | — | ready |
| 13 | **`PH.9`** | PH | C | S | — | ready |
| 14 | **`TC.8`** | TC | C | S | — | ready |
| 15 | **`AT.6`** | AT | C | M | — | ready |
...
The highest ADR is 0115 (0090–0115 were written after this section was first measured; 0093–0115 by `PT.8`, `TC.1`, `PT.18`, `TC.2`, `TC.4`, `PH.13`, `TC.3`, `TC.5`, `PH.1`, `PT.11`, `PT.12`, `PT.21`, `TC.7`, `PT.15`, `PT.22`, `PH.3`, `PT.9`, `WM.5`, `PT.14`, `WM.6`, `AT.10`, `PH.6` and `PH.7`). Four numbers below 0089 are cited and were never written: **0042** (the Level B
