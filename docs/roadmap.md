...
| PT.9 | ✅ **done, engine-free and rendered.** `quad_outbound_pointwise.yaml` + `irsim_isaac.quad_outbound` + its driver film the drone 12→150 m against sky, deck/belly/arms per cell on prims that exist; the ENU scene stays the oracle. Camera moves, aircraft still (ADR 0123): a moving frame loses its occluders. | **Measured.** Deck − belly **29.3 K** rendered and 29.3 K in the oracle (per-prim 0.000); 27 K across one arm; deck excess 29.3 K on the pad → 13.8 K at 13 m/s. 115 px → 12.7 px; boresight 7.6° clear of the horizon, refused otherwise. 17 cases. | PT.1, PT.2, PT.5, WM.3 | M | A |
...
The highest ADR is 0122 (0090–0122 were written after this section was first measured; 0093–0122 by `PT.8`, `TC.1`, `PT.18`, `TC.2`, `TC.4`, `PH.13`, `TC.3`, `TC.5`, `PH.1`, `PT.11`, `PT.12`, `PT.21`, `TC.7`, `PT.15`, `PT.22`, `PH.3`, `PT.9`, `WM.5`, `PT.14`, `WM.6`, `AT.10`, `PH.6`, `PH.7`, `PH.8`, `SC.4`, `SE.1`, `AT.7`, `PH.10`, `PH.11` and `PH.12`). Four numbers below 0089 are cited and were never written: **0042** (the Level B
