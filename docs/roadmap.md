...
### Start here → `PT.18` · Point-wise surface temperature

> **Occluders and daylight in the config path.** Schema v8: `occluders:` rectangles feed `cell_shadow`; `patch_solar_loading` supplies q_solar per cell; the car driver gains the solar term it lacks. `shaded: true` plus an occluder on one surface is refused — two shadow authorities.

`PT.18` is phase P, size S, and unblocks 10 other step(s).

#### Then, in order — 109 open steps

| # | step | lane | phase | size | unblocks | waiting on |
|---|---|---|---|---|---|---|
| 1 | **`PT.18`** | PT | P | S | 10 | ready |
| 2 | **`TC.2`** | TC | P | M | 10 | ready |
| 3 | **`WM.1`** | WM | P | M | 10 | ready |
| 4 | **`WM.2`** | WM | P | M | 9 | `WM.1` |
| 5 | **`WM.3`** | WM | P | M | 8 | `WM.2` |
| 6 | **`TC.4`** | TC | P | S | 6 | `TC.2` |
| 7 | **`PH.4`** | PH | P | M | 6 | ready |
| 8 | **`TC.3`** | TC | P | M | 6 | `TC.2` |
| 9 | **`PT.7`** | PT | P | M | 5 | ready |
| 10 | **`TC.5`** | TC | P | M | 5 | `TC.3`, `TC.4` |
| 11 | **`PH.1`** | PH | P | M | 4 | ready |
| 12 | **`PH.5`** | PH | P | M | 4 | `PH.4` |
| 13 | **`TC.6`** | TC | P | M | 4 | `TC.5`, `PT.18` |
| 14 | **`PT.11`** | PT | P | L | 4 | `PT.7` |
| 15 | **`PT.12`** | PT | P | M | 2 | `PT.11` |
