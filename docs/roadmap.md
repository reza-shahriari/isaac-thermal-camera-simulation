...
### Start here → `TC.2` · Thermal coupling

> **A thermal network: nodes, links and a fluid node.** `irsim.thermal.network`: nodes with capacity C; MuSES's boundary kinds: fixed temperature, imposed heat Q [W], convection to a fluid node (hA, T_fluid); links as h_c·A or G [W/K], with an optional node of their own (a rubber mount); radiation lin

`TC.2` is phase P, size M, and unblocks 10 other step(s).

#### Then, in order — 108 open steps

| # | step | lane | phase | size | unblocks | waiting on |
|---|---|---|---|---|---|---|
| 1 | **`TC.2`** | TC | P | M | 10 | ready |
| 2 | **`WM.1`** | WM | P | M | 10 | ready |
| 3 | **`WM.2`** | WM | P | M | 9 | `WM.1` |
| 4 | **`WM.3`** | WM | P | M | 8 | `WM.2` |
| 5 | **`TC.4`** | TC | P | S | 6 | `TC.2` |
| 6 | **`PH.4`** | PH | P | M | 6 | ready |
| 7 | **`TC.3`** | TC | P | M | 6 | `TC.2` |
| 8 | **`PT.7`** | PT | P | M | 5 | ready |
| 9 | **`TC.5`** | TC | P | M | 5 | `TC.3`, `TC.4` |
| 10 | **`PH.1`** | PH | P | M | 4 | ready |
| 11 | **`PH.5`** | PH | P | M | 4 | `PH.4` |
| 12 | **`TC.6`** | TC | P | M | 4 | `TC.5` |
| 13 | **`PT.11`** | PT | P | L | 4 | `PT.7` |
| 14 | **`PT.12`** | PT | P | M | 2 | `PT.11` |
| 15 | **`PT.21`** | PT | P | M | 2 | ready |
...
The highest ADR is 0095 (0090–0095 were written after this section was first measured; 0093–0095 by `PT.8`, `TC.1` and `PT.18`). Four numbers below 0089 are cited and were never written: **0042** (the Level B
